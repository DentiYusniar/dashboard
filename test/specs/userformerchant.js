...
describe('User Page', () => {
    ...
    it('should create username already exist', async () => {
        ...
        await UserPage.lastName.setValue('O');
        await UserPage.userName.setValue('store.o');
        await UserPage.email.setValue('store.oo@mail.co.id');
        await UserPage.phoneNumber.setValue('089733335659');
        await UserPage.role.selectByIndex('1');
        await UserPage.storeId.click();
        await browser.pause(2000);
        await UserPage.storeId.selectByIndex('1');
    ...
    it('should create email already use', async () => {
        ...
        await UserPage.firstName.setValue('Store');
        await UserPage.lastName.setValue('P');
        await UserPage.userName.setValue('store.p');
        await UserPage.email.setValue('store.o@mail.co.id');
        await UserPage.phoneNumber.setValue('089733335657');
        await UserPage.role.selectByIndex('1');
        await UserPage.storeId.click();
        await browser.pause(2000);
        await UserPage.storeId.selectByIndex('1');
    ...
    it('should create phone number already use', async () => {
        ...
        await UserPage.firstName.setValue('Store');
        await UserPage.lastName.setValue('R');
        await UserPage.userName.setValue('store.r');
        await UserPage.email.setValue('store.r@mail.co.id');
        await UserPage.phoneNumber.setValue('089733335656');
        await UserPage.role.selectByIndex('1');
        await UserPage.storeId.click();
        await browser.pause(2000);
    ...
    it('should password do not match', async () => {
        ...
        await UserPage.firstName.setValue('Store');
        await UserPage.lastName.setValue('S');
        await UserPage.userName.setValue('store.s');
        await UserPage.email.setValue('store.s@mail.co.id');
        await UserPage.phoneNumber.setValue('089733335657');
        await UserPage.role.selectByIndex('1');
        await UserPage.storeId.click();
        await browser.pause(2000);
    ...
    it('should search by username', async () => {
        ...
        await UserPage.search[0].setValue('store.o');
        await browser.pause(2000);
    
        await expect(UserPage.search[0]).toHaveValue('store.o');
    ...
    it('should search by phone number', async () => {
        ...
        await UserPage.search[1].setValue('089733335656');
        await browser.pause(2000);
    
        await expect(UserPage.search[1]).toHaveValue('089733335656');
    ...
    it('should search by email', async () => {
        ...
        await UserPage.search[2].setValue('store.o@mail.co.id');
        await browser.pause(2000);
    
        await expect(UserPage.search[2]).toHaveValue('store.o@mail.co.id');
