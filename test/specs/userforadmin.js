...
describe('User Page', () => {
    ...
    it('should create user owner', async () => {

        await UserPage.addButton.click();
        await browser.pause(2000);

        await UserPage.firstName.setValue('Owner');
        await UserPage.lastName.setValue('O');
        await UserPage.userName.setValue('owner.o');
        await UserPage.email.setValue('owner.o@mail.co.id');
        await UserPage.phoneNumber.setValue('089732225656');
        await UserPage.role.selectByIndex('4');
        await UserPage.ownerId.click();
        await browser.pause(2000);
        await UserPage.ownerId.setValue('orang');
    ...
    */
    ...
    it('should create username already exist', async () => {
        ...
        await UserPage.firstName.setValue('Merchant');
        await UserPage.lastName.setValue('K');
        await UserPage.userName.setValue('merchant.o');
        await UserPage.email.setValue('merchant.k@mail.co.id');
        await UserPage.phoneNumber.setValue('089722225656');
        await UserPage.role.selectByIndex('3');
        await UserPage.ownerId.click();
        await browser.pause(2000);
        await UserPage.ownerId.setValue('orang');
        ...
        await expect(UserPage.message).toHaveTextContaining('Username');
        await browser.pause(2000);
    ...
    it('should create email already use', async () => {
        ...
        await UserPage.firstName.setValue('Merchant');
        await UserPage.lastName.setValue('K');
        await UserPage.userName.setValue('merchant.k');
        await UserPage.email.setValue('merchant.o@mail.co.id');
        await UserPage.phoneNumber.setValue('089722225656');
        await UserPage.role.selectByIndex('3');
        await UserPage.ownerId.click();
    ...
    it('should search by username', async () => {
        ...
        await expect(UserPage.searchU[0]).toHaveValue('merchant.o');
    ...
    it('should search by phone number', async () => {
        ...
        await UserPage.search[0].setValue('089722225656');
        await browser.pause(2000);
    
        await expect(UserPage.search[0]).toHaveValue('089722225656');
        console.log(await UserPage.search[0].getValue());

        await UserPage.search[0].click();
    ...
    it('should search by email', async () => {
        ...
        await UserPage.search[1].setValue('merchant.o@mail.co.id');
        await browser.pause(2000);
    
        await expect(UserPage.search[1]).toHaveValue('merchant.o@mail.co.id');
