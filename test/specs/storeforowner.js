...
describe('Store Page', () => {
    ...
    it('should create store', async () => {
        ...
        await StorePage.merchantId.click();
        await browser.pause(3000);
        await StorePage.merchantId.setValue('Merchant');
    ...
    it('should create empty merchant', async () => {

        await StorePage.addButton.click();

        await StorePage.storeName.setValue('Example Store c');
        ...
        //expect
        await expect(StorePage.message).toHaveTextContaining('MerchantId could not be empty');
        await browser.pause(2000);
